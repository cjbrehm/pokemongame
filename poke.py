...
for pokemon in player.pokedex:
    print(pokemon.name)
while len(Trainer.pokedex) != 12 or len(Trainer.pokedex) == 0:
    if len(Trainer.pokedex) == 12:
        print("Way to go! You caught all the pokemon. You win! ")
        sys.exit()
    elif len(Trainer.pokedex) == 0:
